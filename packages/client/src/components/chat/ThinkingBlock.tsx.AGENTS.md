...
New `inlineFlow?: boolean` prop: body drops `max-h-[400px] overflow-y-auto` (keeps `overflow-x-auto`) — HEIGHT ONLY, collapse machinery untouched. See change: render-inline-reasoning-and-custom-entries.

...
export default function App() {
  ...
  }, [beginLoadingHistory, beginReplayInFlight, selectedId, send, status]);
    ...
    <div className="flex h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      ...
      <div className="relative flex-1 flex flex-col min-w-0 min-h-0">
        ...
        {settingsMatch && !firstLaunchModal && (
          ...
          return models;
        })()} onMessage={onMessage} onBack={dismissOverlay} selectedCwd={selectedCwd} compactSidebar={sidebar.compact} onCompactSidebarChange={sidebar.setCompact} />
          </RouteBackedOverlay>
        )}
